...
public class DirectorView extends JPanel implements Dashboard.Refreshable {
    ...
    private JButton approveStructuralButton, approveNoStructuralButton, notRecommendButton, deferButton, viewDocumentsButton; // Added viewDocumentsButton
    ...
    private void approveForStructural() {
        ...
        clearDetails();
        refreshData();
        parentDashboard.showRoleDashboard("Director");
    }
