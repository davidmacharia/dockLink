...
public class DirectorReportsPanel extends JPanel implements Dashboard.Refreshable {
    ...
    public DirectorReportsPanel(User user, Dashboard parentDashboard, DashboardCardsPanel cardsPanel) {
        ...
        // Panel Title
        JLabel panelTitle = new JLabel("Director's Reports");
    ...
    private void generateStatusReport() {
        reportOutputArea.setText("--- Director's Overall Workflow Status Report ---\n");
    ...
    private void generateProcessingTimeReport() {
        reportOutputArea.setText("--- Director's Average Processing Time Report ---\n");
        reportOutputArea.append("Date: " + LocalDate.now() + "\n\n");
    ...
    private void generateRejectionDeferralReport() {
        reportOutputArea.setText("--- Director's Rejection/Deferral Analysis Report ---\n");
        reportOutputArea.append("Date: " + LocalDate.now() + "\n\n");
    ...
    private void generateBillingOverviewReport() {
        reportOutputArea.setText("--- Director's Billing Overview Report ---\n");
        reportOutputArea.append("Date: " + LocalDate.now() + "\n\n");
